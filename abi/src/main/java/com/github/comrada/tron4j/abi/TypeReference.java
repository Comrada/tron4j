 ...
 */
public abstract class TypeReference<T extends com.github.comrada.tron4j.abi.datatypes.Type>
    ...
    public static <T extends com.github.comrada.tron4j.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends com.github.comrada.tron4j.abi.datatypes.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends com.github.comrada.tron4j.abi.datatypes.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends com.github.comrada.tron4j.abi.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends com.github.comrada.tron4j.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends com.github.comrada.tron4j.abi.datatypes.Type> baseClass =
        ...
        while (lastReadStringPosition < len) {
            ...
            if (arraySize == null || arraySize.equals("")) {
                ...
                if (arraySizeInt <= StaticArray.MAX_SIZE_OF_STATIC_ARRAY) {
                    arrayclass =
                            Class.forName(
                                    "com.github.comrada.tron4j.abi.datatypes.generated.StaticArray" + arraySize);
                } else {
